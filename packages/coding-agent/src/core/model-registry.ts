...
export class ModelRegistry {
	 ...
	 * This is a fast check that doesn't resolve command-backed config values.
	 */
	...
	/**
	 * Subscription/OAuth auth is not supported.
	 */
	 ...
	 * Also resets dynamic API stream registrations before reapplying
